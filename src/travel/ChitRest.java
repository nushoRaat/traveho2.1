 ...
 * @author user
 */
public class ChitRest extends javax.swing.JFrame {
    ...
    public ChitRest() throws IOException {
        initComponents();
        Document doc = Jsoup.connect("https://www.lonelyplanet.com/bangladesh/chittagong/restaurants/a/poi-eat/355773").userAgent("mozilla/17.0").get();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Restaurants of Chittagong\n");
        ...
        setSize(new java.awt.Dimension(1224, 800));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChitRest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(ChitRest.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
