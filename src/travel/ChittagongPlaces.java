...
public class ChittagongPlaces extends javax.swing.JFrame {
    ...
    public class Myclass
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 2430, 340));
        ...
        jTextField1.setText("Place Of Chittagong");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -1, 2430, 60));
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/travel/backChit.jpg"))); // NOI18N
        getContentPane().add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 2430, 2160));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChittagongPlaces.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
public ArrayList listUser()
{
    ...
    ArrayList<Myclass> list = new ArrayList<Myclass>();
        ...
        try
        {
          ...
          Document doc = Jsoup.connect("https://www.lonelyplanet.com/bangladesh/chittagong/attractions/a/poi-sig/355773").userAgent("Mozilla/17.0").get();
