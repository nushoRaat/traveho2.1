 ...
 * @author user
 */
public class DhakaRest extends javax.swing.JFrame {

    String n = null;
    String m = null;
    /**
     * Creates new form DhakaRest
     */
    public DhakaRest() throws IOException {
        initComponents();
        
        
        
         Document doc = Jsoup.connect("https://www.lonelyplanet.com/bangladesh/dhaka/restaurants/a/poi-eat/355783").userAgent("mozilla/17.0").get();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Restaurants of Dhaka");
        ...
        rest.setBackground(new java.awt.Color(255, 255, 255,50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DhakaRest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(DhakaRest.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
