...
public class MymensingPlaces extends javax.swing.JFrame {
    ...
    public class Myclass
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 2620, 210));

        jTextField1.setEditable(false);
        jTextField1.setBackground(new java.awt.Color(204, 204, 255));
        jTextField1.setFont(new java.awt.Font("Dialog", 1, 48)); // NOI18N
        jTextField1.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextField1.setText("Place Of Mymensing");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -1, 2620, 60));
        ...
        getContentPane().add(back1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 590, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/travel/newpackage/backmymen.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 2620, 2550));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MymensingPlaces.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
public ArrayList listUser()
{
    ...
    ArrayList<Myclass> list = new ArrayList<Myclass>();
        ...
        try
        {
          ...
          Document doc = Jsoup.connect("https://www.lonelyplanet.com/bangladesh/mymensingh/attractions/a/poi-sig/355787").userAgent("Mozilla/17.0").get();
