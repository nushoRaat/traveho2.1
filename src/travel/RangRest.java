 ...
 * @author user
 */
public class RangRest extends javax.swing.JFrame {

    
    String n = null;
    String m = null;
    /**
     * Creates new form RangRest
     */
    public RangRest() throws IOException {
        initComponents();
        
        Document doc = Jsoup.connect("https://www.lonelyplanet.com/bangladesh/rangpur/restaurants/a/poi-eat/355809").userAgent("mozilla/17.0").get();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Restaurants of Rangpur");
        ...
        setSize(new java.awt.Dimension(895, 634));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RangRest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(RangRest.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
