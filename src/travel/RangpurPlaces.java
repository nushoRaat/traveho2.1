...
public class RangpurPlaces extends javax.swing.JFrame {
    ...
    public class Myclass
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 2190, 120));
        ...
        jTextField1.setText("Place Of Rangpur");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -1, 2190, 70));
        ...
        getContentPane().add(back1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 600, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/travel/newpackage/backrong.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 2190, 1270));

        setSize(new java.awt.Dimension(2203, 1324));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RangpurPlaces.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
public ArrayList listUser()
{
    ...
    ArrayList<Myclass> list = new ArrayList<Myclass>();
        ...
        try
        {
          ...
          Document doc = Jsoup.connect("https://www.lonelyplanet.com/bangladesh/rangpur/attractions/a/poi-sig/355809").userAgent("Mozilla/17.0").get();
