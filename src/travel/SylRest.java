 ...
 * @author user
 */
public class SylRest extends javax.swing.JFrame {

    String n = null;
    String m = null;
    /**
     * Creates new form SylRest
     */
    public SylRest() throws IOException {
        initComponents();
        
        Document doc = Jsoup.connect("https://www.lonelyplanet.com/bangladesh/sylhet/restaurants/a/poi-eat/355817").userAgent("mozilla/17.0").get();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Restaurants of Sylhet");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SylRest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(SylRest.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
