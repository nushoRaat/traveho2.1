...
public class SylhetPlaces extends javax.swing.JFrame {
    ...
    public class Myclass
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 1890, 240));
        ...
        jTextField1.setText("Place Of Sylhet");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -1, 1890, 70));
        ...
        getContentPane().add(back1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 560, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/travel/newpackage/backsylh.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1890, 1540));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SylhetPlaces.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
public ArrayList listUser()
{
    ...
    ArrayList<Myclass> list = new ArrayList<Myclass>();
        ...
        try
        {
          ...
          Document doc = Jsoup.connect("https://www.lonelyplanet.com/bangladesh/sylhet/attractions/a/poi-sig/355817").userAgent("Mozilla/17.0").get();
