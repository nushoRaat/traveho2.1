...
public class hotelKhulna extends javax.swing.JFrame {

    /**
     * Creates new form hotelKhulna
     */
    
    String n =null;
    String m = null;
    
    public hotelKhulna() throws IOException {
        initComponents();
    
        Document doc = Jsoup.connect("https://www.lonelyplanet.com/bangladesh/khulna/hotels/a/lod/355793").userAgent("mozilla/17.0").get();
    ...
    private void initComponents() {
        ...
        head.setPreferredSize(new java.awt.Dimension(875, 150));

        jLabel2.setFont(new java.awt.Font("Vivaldi", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Hotels Of  Khulna");
        ...
        iconpan.setPreferredSize(new java.awt.Dimension(350, 400));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hotelKhulna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(hotelKhulna.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
